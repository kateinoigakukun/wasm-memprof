...
export const perftools = $root.perftools = (() => {
    ...
    perftools.profiles = (function() {
        ...
        profiles.Profile = (function() {
            ...
            Profile.decode = function decode(reader, length) {
                ...
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.perftools.profiles.Profile();
            ...
            Profile.verify = function verify(message) {
                ...
                if (message.sampleType != null && message.hasOwnProperty("sampleType")) {
                    ...
                    for (let i = 0; i < message.sampleType.length; ++i) {
                        let error = $root.perftools.profiles.ValueType.verify(message.sampleType[i]);
                        if (error)
                ...
                if (message.sample != null && message.hasOwnProperty("sample")) {
                    ...
                    for (let i = 0; i < message.sample.length; ++i) {
                        let error = $root.perftools.profiles.Sample.verify(message.sample[i]);
                        if (error)
                            return "sample." + error;
                    }
                }
                if (message.mapping != null && message.hasOwnProperty("mapping")) {
                    ...
                    for (let i = 0; i < message.mapping.length; ++i) {
                        let error = $root.perftools.profiles.Mapping.verify(message.mapping[i]);
                        if (error)
                ...
                if (message.location != null && message.hasOwnProperty("location")) {
                    ...
                    for (let i = 0; i < message.location.length; ++i) {
                        let error = $root.perftools.profiles.Location.verify(message.location[i]);
                        if (error)
                ...
                if (message["function"] != null && message.hasOwnProperty("function")) {
                    ...
                    for (let i = 0; i < message["function"].length; ++i) {
                        let error = $root.perftools.profiles.Function.verify(message["function"][i]);
                        if (error)
                ...
                if (message.periodType != null && message.hasOwnProperty("periodType")) {
                    let error = $root.perftools.profiles.ValueType.verify(message.periodType);
                    if (error)
            ...
            Profile.fromObject = function fromObject(object) {
                if (object instanceof $root.perftools.profiles.Profile)
                    return object;
                let message = new $root.perftools.profiles.Profile();
                if (object.sampleType) {
                    ...
                    message.sampleType = [];
                    for (let i = 0; i < object.sampleType.length; ++i) {
                ...
                if (object.sample) {
                    ...
                    message.sample = [];
                    for (let i = 0; i < object.sample.length; ++i) {
                ...
                if (object.stringTable) {
                    ...
                    message.stringTable = [];
                    for (let i = 0; i < object.stringTable.length; ++i)
            ...
            Profile.toObject = function toObject(message, options) {
                ...
                if (message.stringTable && message.stringTable.length) {
                    object.stringTable = [];
                    for (let j = 0; j < message.stringTable.length; ++j)
        ...
        profiles.ValueType = (function() {
            ...
            ValueType.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.perftools.profiles.ValueType();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
            ...
            ValueType.fromObject = function fromObject(object) {
                if (object instanceof $root.perftools.profiles.ValueType)
                    return object;
                let message = new $root.perftools.profiles.ValueType();
                if (object.type != null)
                    if ($util.Long)
        ...
        profiles.Sample = (function() {
            ...
            Sample.encode = function encode(message, writer) {
                ...
                if (message.locationId != null && message.locationId.length) {
                    ...
                    for (let i = 0; i < message.locationId.length; ++i)
            ...
            Sample.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.perftools.profiles.Sample();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
            ...
            Sample.verify = function verify(message) {
                ...
                if (message.label != null && message.hasOwnProperty("label")) {
                    ...
                    for (let i = 0; i < message.label.length; ++i) {
                        let error = $root.perftools.profiles.Label.verify(message.label[i]);
                        if (error)
                            return "label." + error;
                    }
                }
            ...
            Sample.fromObject = function fromObject(object) {
                if (object instanceof $root.perftools.profiles.Sample)
                    return object;
                let message = new $root.perftools.profiles.Sample();
                if (object.locationId) {
                    ...
                    message.locationId = [];
                    for (let i = 0; i < object.locationId.length; ++i)
                        if ($util.Long)
            ...
            Sample.toObject = function toObject(message, options) {
                ...
                if (message.locationId && message.locationId.length) {
                    object.locationId = [];
                    for (let j = 0; j < message.locationId.length; ++j)
        ...
        profiles.Label = (function() {
            ...
            Label.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.perftools.profiles.Label();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
            ...
            Label.fromObject = function fromObject(object) {
                if (object instanceof $root.perftools.profiles.Label)
                    return object;
                let message = new $root.perftools.profiles.Label();
                if (object.key != null)
                    if ($util.Long)
        ...
        profiles.Mapping = (function() {
            ...
            Mapping.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.perftools.profiles.Mapping();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
            ...
            Mapping.fromObject = function fromObject(object) {
                if (object instanceof $root.perftools.profiles.Mapping)
                    return object;
                let message = new $root.perftools.profiles.Mapping();
                if (object.id != null)
                    if ($util.Long)
        ...
        profiles.Location = (function() {
            ...
            Location.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.perftools.profiles.Location();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
            ...
            Location.verify = function verify(message) {
                ...
                if (message.line != null && message.hasOwnProperty("line")) {
                    ...
                    for (let i = 0; i < message.line.length; ++i) {
                        let error = $root.perftools.profiles.Line.verify(message.line[i]);
                        if (error)
                            return "line." + error;
                    }
                }
            ...
            Location.fromObject = function fromObject(object) {
                if (object instanceof $root.perftools.profiles.Location)
                    return object;
                let message = new $root.perftools.profiles.Location();
                if (object.id != null)
                    if ($util.Long)
                        (message.id = $util.Long.fromValue(object.id)).unsigned = true;
                    else if (typeof object.id === "string")
            ...
            Location.toObject = function toObject(message, options) {
                ...
                if (message.line && message.line.length) {
                    object.line = [];
                    for (let j = 0; j < message.line.length; ++j)
        ...
        profiles.Line = (function() {
            ...
            Line.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.perftools.profiles.Line();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
            ...
            Line.fromObject = function fromObject(object) {
                if (object instanceof $root.perftools.profiles.Line)
                    return object;
                let message = new $root.perftools.profiles.Line();
        ...
        profiles.Function = (function() {
            ...
            Function.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.perftools.profiles.Function();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
            ...
            Function.fromObject = function fromObject(object) {
                if (object instanceof $root.perftools.profiles.Function)
                    return object;
                let message = new $root.perftools.profiles.Function();
                if (object.id != null)
                    if ($util.Long)
                        (message.id = $util.Long.fromValue(object.id)).unsigned = true;
                    else if (typeof object.id === "string")
